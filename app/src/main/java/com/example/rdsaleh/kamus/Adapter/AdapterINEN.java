...
public class AdapterINEN extends RecyclerView.Adapter<AdapterINEN.MyViewHolder> {

    private ArrayList<KamusModel> kamusModels = new ArrayList<>();
    private Context mContext;
    private LayoutInflater mInflater;

    public AdapterINEN(Context mContext){
    ...
    @NonNull
    @Override
    public AdapterINEN.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.data_in, viewGroup, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterINEN.MyViewHolder myViewHolder, int i) {
